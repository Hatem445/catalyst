...
const Renderer = {
  ...
  home(adaptiveHome = null) {
    ...
    const hero = `
      <div class="home-hero fade-in">
        <div class="hero-brand-wrap">
          ...
          <div class="hero-sub">العامل الحفاز لتعلّم الكيمياء</div>
    ...
    const learningTracks = `
      <div class="home-paths fade-in fade-in-delay-1">
        <section class="glass-card home-path-card">
          ...
          <div class="home-path-actions">
            <button class="home-quick-btn" data-action="tab" data-tab="home">الوحدات الدراسية</button>
        ...
        <section class="glass-card home-path-card">
          ...
          <div class="home-path-desc">مراجعة مركزة وسريعة قبل الاختبار.</div>
          <div class="home-path-actions">
            <button class="home-quick-btn" data-action="tab" data-tab="home">خطة اليوم</button>
        ...
        <section class="glass-card home-path-card">
          ...
          <div class="home-path-actions">
            ...
            <button class="home-quick-btn" data-action="tab" data-tab="laws">القوانين التطبيقية</button>
          </div>
        </section>
      </div>`;
    ...
    return hero + stats + planHtml + learningTracks + weakBox + `<div class="section-label">الوحدات الدراسية</div><div class="units-grid">${unitsHtml}</div>`;
  },
