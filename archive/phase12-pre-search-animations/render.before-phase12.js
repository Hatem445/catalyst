...
const Renderer = {
  ...
  organic() {
    ...
    const animations = [
      {
        id: 'rxn_anim_1',
        title: 'إضافة على رابطة مزدوجة في الألكينات',
        type: 'alkene_addition',
        steps: {
          reactants: 'CH₂=CH₂ + Br₂',
          condition: 'مذيب خامل مثل CCl₄',
          product: 'BrCH₂-CH₂Br',
          note: 'الرابطة π تنكسر أولًا فتسمح بإضافة الذرات.',
        },
      },
      {
        id: 'rxn_anim_2',
        title: 'أكسدة كحول أولي',
        type: 'alcohol_oxidation',
        steps: {
          reactants: 'CH₃CH₂OH',
          condition: 'K₂Cr₂O₇ / H₂SO₄',
          product: 'CH₃CHO ثم CH₃COOH',
          note: 'توقف مبكرًا إذا كان الهدف ألدهيدًا فقط.',
        },
      },
      {
        id: 'rxn_anim_3',
        title: 'الأسترة بين حمض كربوكسيلي وكحول',
        type: 'esterification',
        steps: {
          reactants: 'CH₃COOH + C₂H₅OH',
          condition: 'H₂SO₄ مركز + تسخين',
          product: 'CH₃COOC₂H₅ + H₂O',
          note: 'إزالة الماء تحسن نسبة تكوين الإستر.',
        },
      },
    ];
