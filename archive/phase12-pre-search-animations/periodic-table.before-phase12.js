  ...
  return `
    ...
    <div class="glass-card periodic-head fade-in">
      <div class="search-box" style="margin-bottom:10px">
        <input class="search-input" type="search" data-action="periodic-search-input" placeholder="ابحث: رمز، اسم عربي/English، عدد ذري" value="${query}" autocomplete="off" />
      ...
      <div class="periodic-filter-row">
        ...
        ${query ? '<button class="periodic-filter-btn" data-action="periodic-clear-search">مسح</button>' : ''}
      </div>
      ${transitionBadge}
