...
const Renderer = {
  ...
  home(adaptiveHome = null) {
      ...
      <div class="home-paths fade-in fade-in-delay-1">
        ...
        <section class="glass-card home-path-card">
          ...
          <div class="home-path-actions">
            ...
            <button class="home-quick-btn" data-action="tab" data-tab="laws">مراجع القوانين</button>
    ...
    return hero + stats + learningTracks + `<div class="section-label">ابدأ من الوحدات الرئيسية</div><div class="units-grid">${unitsHtml}</div>`;
  },
