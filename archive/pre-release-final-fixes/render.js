      ...
      <div class="organic-page">
        ...
        <section class="organic-section">
          ...
          <div class="organic-activity-card" data-activity="reagent1" data-correct="b">
            ...
            <div class="organic-grid-2">
              <button class="organic-chip-btn" data-action="organic-reagent-select" data-choice-key="a">${C.formula('H2/Ni')}</button>
              <button class="organic-chip-btn" data-action="organic-reagent-select" data-choice-key="b">${C.formula('H2O/H2SO4')}</button>
              <button class="organic-chip-btn" data-action="organic-reagent-select" data-choice-key="c">${C.formula('Br2')}</button>
              <button class="organic-chip-btn" data-action="organic-reagent-select" data-choice-key="d">NaOH(aq)</button>
            </div>
            <div class="organic-activity-actions">
