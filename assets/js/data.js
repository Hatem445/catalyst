...
const QUIZ_RAW = [
  { level:'سهل', q:'ما الصيغة العامة للألكينات؟', opts:['CₙH₂ₙ₊₂','CₙH₂ₙ₋₂','CₙH₂ₙ','CₙHₙ'], ans:2, explain:'الألكينات تحتوي رابطة ثنائية واحدة؛ لذلك صيغتها CₙH₂ₙ.' },
  ...
  { level:'متوسط', q:'أي المركبات التالية يعطي مرآة فضية مع كاشف تولنز؟', opts:['CH₃COCH₃','CH₃CHO','C₂H₅OH','CH₃COOH'], ans:1, explain:'الألدهيدات تختزل أيون الفضة في كاشف تولنز فتظهر المرآة الفضية.' },
  ...
  { level:'صعب', q:'ما ناتج تصبن إيثانوات الإيثيل CH₃COOC₂H₅ مع NaOH؟', opts:['CH₃COOH + C₂H₅OH','CH₃COONa + C₂H₅OH','CH₃CHO + C₂H₅ONa','CH₄ + CO₂'], ans:1, explain:'التصبن (التحلل القلوي) يعطي ملح الحمض + كحول، وهو تفاعل غير عكسي.' },
  ...
  { level:'متوسط', q:'أي عنصر ينتمي لمجموعة الهالوجينات؟', opts:['Ne','Cl','Ar','Mg'], ans:1, explain:'الكلور Cl من عناصر المجموعة 17 (الهالوجينات).', topic:'qualitative', unitId:'qualitative', difficulty:'متوسط' },
  { level:'سهل', q:'أي من الآتي غاز نبيل؟', opts:['Na','O','Xe','Br'], ans:2, explain:'Xe (زينون) من الغازات النبيلة في المجموعة 18.', topic:'transition', unitId:'transition', difficulty:'سهل' },
  { level:'متوسط', q:'ما المجموعة الدورية للفلزات القلوية؟', opts:['1','2','17','18'], ans:0, explain:'الفلزات القلوية تقع في المجموعة 1 (عدا الهيدروجين).', topic:'transition', unitId:'transition', difficulty:'متوسط' },
  { level:'متوسط', q:'لماذا يتحول الإيثانول إلى إيثر عند 140°C مع H₂SO₄؟', opts:['لأن الماء يزيد','لأن نزع الماء بين جزيئين يفضَّل','لأن الأكسدة أسرع','لأن التفاعل ضوئي'], ans:1, explain:'عند 140°C يفضَّل تكاثف جزيئين كحول وتكوين الإيثر.', topic:'organic_derivatives', unitId:'org_derivatives', difficulty:'متوسط' },
  { level:'صعب', q:'في تصبن الإستر، لماذا يكون التفاعل شبه غير عكسي؟', opts:['لأن الماء يتطاير فقط','لتكوّن ملح الكربوكسيلات المستقر','لأن الحرارة منخفضة','لأن الحمض قوي'], ans:1, explain:'تكوّن الملح (RCOO⁻Na⁺) يسحب التفاعل ناحية النواتج.', topic:'organic_derivatives', unitId:'org_derivatives', difficulty:'صعب' },
  { level:'متوسط', q:'أي شرط مناسب لتحويل C₂H₄ إلى C₂H₆؟', opts:['Br₂/CCl₄','H₂/Ni','K₂Cr₂O₇/H₂SO₄','FeCl₃'], ans:1, explain:'الهدرجة (H₂/Ni) تضيف هيدروجين للرابطة الثنائية.', topic:'organic_hc', unitId:'hydrocarbons', difficulty:'متوسط' },
  { level:'سهل', q:'ما اسم الاختبار المستخدم غالبًا لتمييز الألدهيد؟', opts:['اختبار اللهب','اختبار تولنز','اختبار باير','اختبار بيكربونات'], ans:1, explain:'الألدهيد يعطي مرآة فضية في اختبار تولنز.', topic:'organic_derivatives', unitId:'org_derivatives', difficulty:'سهل' },
  { level:'صعب', q:'أي سبب يفسر نشاط الكربونيل في الألدهيد أعلى من الكيتون؟', opts:['كتلة أكبر','عائق فراغي أقل','عدد هيدروجين أقل','لا فرق'], ans:1, explain:'الألدهيد أقل ازدحامًا حول كربون الكربونيل.', topic:'organic_derivatives', unitId:'org_derivatives', difficulty:'صعب' },
  { level:'متوسط', q:'في الجدول الدوري، عناصر d-block تقع غالبًا في أي مجموعات؟', opts:['1-2','3-12','13-18','17-18'], ans:1, explain:'العناصر الانتقالية الأساسية تقع في مجموعات 3 إلى 12.', topic:'transition', unitId:'transition', difficulty:'متوسط' },
  { level:'متوسط', q:'أي زوج يمثل تفاعل إحلال في الألكانات؟', opts:['C₂H₄ + Br₂','CH₄ + Cl₂ (UV)','CH₃COOH + C₂H₅OH','C₂H₂ + H₂'], ans:1, explain:'كلورة الميثان بالضوء مثال واضح للإحلال.', topic:'organic_hc', unitId:'hydrocarbons', difficulty:'متوسط' },
  { level:'صعب', q:'للحصول على CH₃COOC₂H₅ بكفاءة أعلى، ماذا تفعل؟', opts:['إضافة ماء','تبريد شديد دائم','إزالة الماء تدريجيًا','استخدام NaOH'], ans:2, explain:'إزالة الماء تدفع اتزان الاسترة للناتج.', topic:'organic_derivatives', unitId:'org_derivatives', difficulty:'صعب' },
];
...
const CARDS_RAW = [
  ...
  { topic:'هيدروكربونات', f:'الصيغ العامة بسرعة', b:'ألكانات: CₙH₂ₙ₊₂\nألكينات: CₙH₂ₙ\nألكاينات: CₙH₂ₙ₋₂', unit:'hydrocarbons' },
  ...
  { topic:'عضوية', f:'مفهوم التصبن', b:'RCOOR + NaOH → RCOONa + ROH\nتفاعل تحلل قلوي غير عكسي', unit:'org_derivatives' },
  ...
  { topic:'دورية', f:'كيف أتعرف سريعًا على الهالوجينات؟', b:'تقع في المجموعة 17:\nF, Cl, Br, I, At, Ts', unit:'qualitative' },
  { topic:'دورية', f:'ما الغازات النبيلة الأساسية؟', b:'He, Ne, Ar, Kr, Xe, Rn, Og\nتقع في المجموعة 18', unit:'transition' },
  { topic:'دورية', f:'قاعدة الفلزات القلوية', b:'المجموعة 1 (عدا H)\nشديدة التفاعل مع الماء', unit:'transition' },
  { topic:'دورية', f:'الفلزات القلوية الأرضية', b:'المجموعة 2: Be, Mg, Ca, Sr, Ba, Ra', unit:'transition' },
  { topic:'عضوية', f:'لماذا الكينات نشطة في الإضافة؟', b:'وجود رابطة π الأضعف نسبيًا يجعلها أكثر قابلية للكسر والتفاعل.', unit:'hydrocarbons' },
  { topic:'عضوية', f:'اختصار شروط الإستر', b:'حمض + كحول + H₂SO₄ + تسخين\nوإزالة الماء لرفع المحصول', unit:'org_derivatives' },
  { topic:'عضوية', f:'أمينات: الفكرة الأساسية', b:'وجود -NH₂ يزيد القاعدية النسبية مقارنةً بالكحولات.', unit:'org_derivatives' },
  { topic:'عضوية', f:'أساسيات البلمرة', b:'مونومر صغير (مثل C₂H₄) → بوليمر طويل\nتتحسن خواص الاستخدام الصناعي.', unit:'hydrocarbons' },
  { topic:'عضوية', f:'فرق سريع: أكسدة الألدهيد والكيتون', b:'الألدهيد يتأكسد بسهولة إلى حمض\nالكيتون أكثر مقاومة في الشروط المعتادة.', unit:'org_derivatives' },
  { topic:'دورية', f:'d-block تعني ماذا؟', b:'غالبًا عناصر انتقالية في المجموعات 3-12\nوتتميز بتعدد حالات التأكسد.', unit:'transition' },
];
