...
const QUIZ_RAW = [
  ...
  { level:'صعب', q:'في صابرة الإستر، لماذا يكون التفاعل شبه غير عكسي؟', opts:['لأن الماء يتطاير فقط','لتكوّن ملح الكربوكسيلات المستقر','لأن الحرارة منخفضة','لأن الحمض قوي'], ans:1, explain:'تكوّن الملح (RCOO⁻Na⁺) يسحب التفاعل للنواتج.', topic:'organic_derivatives', unitId:'org_derivatives', difficulty:'صعب' },
